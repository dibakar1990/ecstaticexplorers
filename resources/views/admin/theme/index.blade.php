...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.tag.create') }}" class="btn btn-sm btn-primary px-3 radius-30">Add New</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" class="statusActionUrl" value="{{route('admin.pakage.tag.status')}}">
                    <input type="hidden" class="actionUrl" value="{{route('admin.pakage.tag.action')}}">
                </div>
            </div>
        </div>
    </div>
