        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    ...
                    data-action-url="{{route('admin.contact.send.bluk-mail')}}" data-title="Send Mail" data-bs-toggle="modal">All Send Mail
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" class="actionUrl" value="{{route('admin.contact.action')}}">
                </div>
            </div>
        </div>
    </div>
