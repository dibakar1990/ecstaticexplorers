            ...
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <form class="row g-3" id="editForm" method="post" action="{{ route('admin.banners.update',['banner' => $item->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="col-md-12 required">
                                <label for="title" class="form-label">Title</label>
                                <input type="text" class="form-control" id="title" name="title" value="{{ $item->title }}" placeholder="Banner title">
                                @error('title')
                            ...
                            <div class="col-md-12 required">
                                ...
                                <input type="text" class="form-control" id="sub_title" name="sub_title" value="{{ $item->sub_title }}" placeholder="Banner sub title">
                                @error('sub_title')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
