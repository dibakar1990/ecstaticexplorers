...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.cities.create') }}" class="btn btn-sm btn-primary px-3 radius-30">Add New</a>
                </div>
            </div>
        </div>
        <!--end breadcrumb-->
        ...
        <div class="row">
            ...
            <div class="col-xxl-2 col-lg-2 mb-3 filter-destination">
                <div class="form-group">
                    <select class="single-select" id="filter_destination" name="top_destination">
                        <option value="">{{ __('Top Destination Search') }}</option>
        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" class="statusActionUrl" value="{{route('admin.city.status')}}">
                    <input type="hidden" class="actionUrl" value="{{route('admin.city.action')}}">
                </div>
            </div>
        </div>
    </div>
        ...
        var table = $('#dataTable').DataTable({
            ...
            ajax: {
                ...
                data: function (d) {
                    ...
                    d.top_destination = $('#filter_destination').val(),
            ...
            columns: [
                ...
                {data: 'name', name: 'name'},
                {data: 'top_destination', name: 'top_destination', orderable: false, searchable: false},
