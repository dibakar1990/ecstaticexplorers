...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">HomeStays</div>
            <div class="ps-3">
            ...
            <div class="col-xl-12 mx-auto">
                ...
                <div class="card">
                    <div class="card-body p-4">
                        <form class="row g-3" id="createForm" method="post" action="{{ route('admin.homestays.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12 required">
                                <label for="title" class="form-label">Title</label>
                                <input type="text" class="form-control" id="title" name="title" placeholder="Homestay title">
                                @error('title')
                            ...
                            <div class="col-md-6 required">
                                ...
                                <input type="text" class="form-control" id="property_classification" name="property_classification" placeholder="Homestay property classification">
                            ...
                            <div class="col-md-6 required">
                                ...
                                <input type="text" class="form-control" id="property_uniqueness" name="property_uniqueness" placeholder="Homestay property uniqueness">
                            ...
                            <div class="col-md-6 required">
                                ...
                                <input type="text" class="form-control" id="traiff" name="traiff" placeholder="Homestay traiff">
                                @error('traiff')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-6 required">
                                ...
                                <input type="text" class="form-control" id="price" name="price" placeholder="Homestay price">
                                @error('price')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="col-md-12 required">
                                ...
                                <textarea class="form-control summernote" rows="5" name="description" id="description" placeholder="Homestay description" required></textarea>
                            ...
                            <div class="col-md-12 required">
                                ...
                                <textarea class="form-control summernote" rows="5" name="benefit" id="description" placeholder="Homestay benefit" required></textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control summernote" rows="5" name="booking_policy" id="booking_policy" placeholder="Homestay booking policy" required></textarea>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control summernote" rows="5" name="cancellation_policy" id="cancellation_policy" placeholder="Homestay cancellation policy" required></textarea>
...
<x-admin.homestay.create-script/>
@endsection