...
<div class="page-wrapper">
    <div class="page-content"> 
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="{{ route('admin.user.add') }}" class="btn btn-sm btn-primary px-3 radius-30">Add User</a>
                </div>  
            </div>
        </div>  
                        ...
                        <tbody>
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex">
                                            <a href="{{ route('admin.user.update', encrypt($user->id)) }}" class="btn btn-sm btn-outline-primary px-1"><i class="bx bxs-edit"></i></a> 
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <a href="{{ route('admin.user.delete', encrypt($user->id)) }}" type="button" class="btn btn-primary">Yes</a> 
                                            </div>   
                                        </div>
                                    </div>
                                </div>
