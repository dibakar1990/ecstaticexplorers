...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <a href="javascript:;" class="btn btn-sm btn-primary px-3 radius-30 openPopup"
                        data-action-url="{{route('admin.newsletter.send.mail')}}" data-title="Send Mail" data-bs-toggle="modal">All Send Mail
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xxl-2 col-lg-2 mb-3">
                <div class="form-group">
                    <select class="single-select" id="select_action" name="select_action">
                        ...
                        <option value="is_send_mail">{{ __('Send Mail') }}</option>
                    </select>
                </div>
            </div>
            <div class="col-xxl-2 col-lg-2 mb-3">
            ...
            <div class="col-xxl-4 col-lg-4 mb-3 filter-search">
                <div class="form-group">
        ...
        <div class="card border-top border-0 border-4 border-primary">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    ...
                    <input type="hidden" class="actionUrl" value="{{route('admin.newsletter.action')}}">
